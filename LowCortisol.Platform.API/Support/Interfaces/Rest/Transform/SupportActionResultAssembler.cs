...
public static class SupportActionResultAssembler
{
        ...
        where TEntity : class
    {
        ...
        return controller.LocalizedProblem(
            titleKey: "Errors.Support.RequestFailed",
            titleFallback: "Support request could not be completed.",
    ...
    private static int MapStatusCode(string? error)
    {
        ...
        if (error.Contains("InvalidStatus", StringComparison.OrdinalIgnoreCase)) return StatusCodes.Status409Conflict;
